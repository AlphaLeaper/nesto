...
{
    return (grid[y][0] == grid[y][1] == grid[y][2] && grid[y][0] != 0);
}

bool game::vertical_check(int x)
{
    return (grid[0][x] == grid[1][x] == grid[2][x] && grid[0][x] != 0);
}

bool game::diagonal_check_lr()
{
    return (grid[0][0] == grid[1][1] == grid[2][2] && grid[1][1] != 0);
}

bool game::diagonal_check_rl()
{
    return (grid[0][2] == grid[1][1] == grid[2][0] && grid[1][1] != 0);
}
